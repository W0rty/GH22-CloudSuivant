...
--
-- Host: localhost    Database: cloudsuivant
-- ------------------------------------------------------
...
CREATE TABLE `files` (
  ...
  `associateUser` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `associateUser` (`associateUser`),
  CONSTRAINT `files_ibfk_1` FOREIGN KEY (`associateUser`) REFERENCES `users` (`id`)
...
-- Dump completed on 2022-11-07 21:01:47
